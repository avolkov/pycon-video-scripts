# Updated linux paths and removed timeout
...
banner_wait_time = 0 # seconds (Default: 15)                                  #  | Number of seconds the script will display render settings before rendering starts.
